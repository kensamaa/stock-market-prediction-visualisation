...
def result():
    ...
    if request.method == 'POST':
        try:
            ...
            if(etc=='tesla'):
                modelname='tesla.h5'
                df= pd.read_csv("E:/programing/python/platform/lab32Stockmarket/TSLA.csv")
            elif(etc=="apple"):
                modelname='apple.h5'
                df= pd.read_csv("E:/programing/python/platform/lab32Stockmarket/AAPL.csv")
            elif(etc=="bank"):
                modelname='bank.h5'
                df=pd.read_csv("E:/programing/python/platform/lab32Stockmarket/BAC.csv")
            else:
                modelname='iam.h5'
                df= pd.read_csv("E:/programing/python/platform/lab32Stockmarket/IAM.csv")
            #prediction
